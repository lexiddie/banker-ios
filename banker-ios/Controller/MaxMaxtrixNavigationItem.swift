//
//  MaxMaxtrixNavigationItem.swift
//  banker-ios
//
...
extension MaxMatrixController {
    ...
    private func setupLeftBarItem() {
        ...
        button.addTarget(self, action: #selector(MaxMatrixController.handleBack(_:)), for: .touchUpInside)
    ...
    private func setupRightBarItem() {
        ...
        button.contentMode = .scaleAspectFit
        button.backgroundColor = UIColor.clear
        button.addTarget(self, action: #selector(MaxMatrixController.handleRandom(_:)), for: .touchUpInside)
